...
#Fig. 3b
## Xenopus
```{r Expected Vs observed Phospho S/T in IDRs - xenopus,eval=FALSE}
...
## Human
```{r Expected Vs observed Phospho S/T in IDRs - human,eval=FALSE}
...
#Fig. 3c
```{r Expected vs Observed phospho S/T distribution in xenopus,eval=FALSE}
