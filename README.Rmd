...
### c
```{r FRAP modelling ,echo=FALSE,message=FALSE,warning=FALSE,fig.height=5,fig.width=5}
...
Avg_Spectrum_ROI1 <- read_delim("37/Avg_Spectrum_ROI1.txt", 
    delim = "\t", escape_double = FALSE, col_names = FALSE, 
    trim_ws = TRUE)
Avg_Spectrum_ROI2 <- read_delim("37/Avg_Spectrum_ROI2.txt", 
    delim = "\t", escape_double = FALSE, col_names = FALSE, 
    trim_ws = TRUE)

#load the data from unbleached regions

Avg_Spectrum_UB1 <- read_delim("FRAP_data/Andres-Sanchez_data//Avg_Spectrum_UB1.txt", 
    delim = "\t", escape_double = FALSE, col_names = FALSE, 
    trim_ws = TRUE)
Avg_Spectrum_UB2 <- read_delim("37/Avg_Spectrum_UB2.txt", 
    delim = "\t", escape_double = FALSE, col_names = FALSE, 
    trim_ws = TRUE)

#load the data from nucleus to normalise with it later on
Avg_Spectrum_nucleus <- read_delim("37/Avg_Spectrum_nucleus.txt", 
     delim = "\t", escape_double = FALSE, col_names = FALSE, 
     trim_ws = TRUE)
