...
#Fig. 3f \## Violin plots for the disorder percentage in all kinases' targets for the three main predictors used in this paper
...
#Fig. 3b
```{r Exoected Vs observed Phospho S/T in IDRs entire function}
...
#Fig. 3c
```{r Expected vs Observed phospho S/T distribution in xenopus}
